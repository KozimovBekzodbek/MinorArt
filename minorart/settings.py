"""
Django settings for minorart project.
...
SECRET_KEY = 'django-insecure-ddnb2)hsq17pz9nham8d#)muatwt2+om3&=zd(xp^e_&##g9n)'
...
WSGI_APPLICATION = 'minorart.wsgi.application'
